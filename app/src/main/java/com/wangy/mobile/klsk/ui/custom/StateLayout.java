...
public class StateLayout extends FrameLayout {
    ...
    public void setTipText(int type, String text) {
        switch (type) {
            case ERROR:
                ((TextView)errorView.findViewById(R.id.tv)).setText(text);
                break;
            case EMPTY:
                ((TextView)emptyView.findViewById(R.id.tv)).setText(text);
                break;
            case TIMEOUT:
                ((TimeOutViewHolder) timeOutView.getTag()).tvTip.setText(text);
                break;
            case NOT_NETWORK:
                ((TextView)notNetworkView.findViewById(R.id.tv)).setText(text);
                break;
            case LOADING:
                ((TextView)loadingView.findViewById(R.id.tv)).setText(text);
                break;
            case LOGIN:
